...
$string['privacy:metadata'] = 'O plugin Penalidade por Atraso armazena sobreposições de penalidade por aluno na tabela local_latepenalty_overrides. Essas sobreposições podem incluir prazo personalizado, taxa diária e limite máximo configurados pelo professor para um aluno e atividade específicos.';
