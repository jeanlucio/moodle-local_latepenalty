...
$string['local/latepenalty:manageoverrides'] = 'Gerenciar sobreposições de penalidade por atraso por aluno';
$string['local/latepenalty:viewreport'] = 'Ver relatório de penalidade por atraso';
